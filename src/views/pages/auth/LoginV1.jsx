...
const LoginV1 = () => {
  ...
  // ✅ Mock login: always redirect
  const onSubmit = data => {
    setLoading(true)

    setTimeout(() => {
      setLoading(false)
      router.replace('/en/dashboards/crm') // forced redirect
    }, 500) // optional delay to show spinner
  }
    ...
    <div className="flex justify-center items-center min-h-screen w-full bg-background">
      <Card className='flex flex-col sm:is-[450px]'>
        <CardContent className='sm:!p-12'>
          ...
          <div className='flex flex-col gap-1 mbe-6'>
            <Typography variant='h4'>{`Welcome to ${themeConfig.templateName}! `}</Typography>
            <Typography>Please sign in to continue using A.</Typography>
          </div>
