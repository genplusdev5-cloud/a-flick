...
import { getEquipmentList, addEquipment, updateEquipment, deleteEquipment, getEquipmentDetails } from '@/api/master/equipments'
...
const EquipmentsPageContent = () => {
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor('name', { header: 'Equipment Name' }),
      ...
      header={
        <Box sx={{ mb: 2 }}>
          <Breadcrumbs aria-label='breadcrumb' sx={{ mb: 2 }}>
            ...
            <Typography color='text.primary'>Equipments</Typography>
          </Breadcrumbs>
        </Box>
      }
    >
      ...
      >
        ...
        >
          ...
          Confirm Delete
          {/* ❌ SAME DELETE DIALOG CLOSE BUTTON */}
