...
const IncidentPageContent = () => {
  ...
  // 🔹 Handle field change + preserve unsaved data
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      const result = isEdit ? await updateIncident(payload) : await addIncident(payload)
  ...
  const exportPrint = () => {
    ...
    const html = `
      <html><head><title>Incident List</title><style>
